...
export 'src/package_info_plus_windows.dart' if (dart.library.js_interop) 'src/package_info_plus_web.dart';
...
class PackageInfo {
  ...
  @override
  String toString() =>
      'PackageInfo(appName: $appName, buildNumber: $buildNumber, packageName: $packageName, version: $version, buildSignature: $buildSignature, installerStore: $installerStore)';
