...
echo "Running Makefile targets for macOS..."
PLATFORM=macos
...
make ci-build-macos ENV_FILE=$ENV_FILE BUILD_NUMBER=$CI_BUILD_NUMBER

echo "CI build for macOS completed successfully."
