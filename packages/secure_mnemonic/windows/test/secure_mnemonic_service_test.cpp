...
namespace secure_mnemonic {
	namespace test {
		...
		class SecureMnemonicServiceTest : public ::testing::Test  {
		protected:
			...
			std::unique_ptr<SecureMnemonicService> m_Service;
			...
			void SetUp() override {
				...
				// Create the service
				m_Service = std::make_unique<SecureMnemonicService>(
					m_ConfigStorage,
		...
		TEST_F(SecureMnemonicServiceTest, GetTPMStatusAsync_ReturnsUnsupportedIfWindowsTpmRepositoryThrows)
		{
			// Set expectations
		...
		TEST_F(SecureMnemonicServiceTest, GetTPMStatusAsync_ReturnsUnsupportedIfWindowsTpmRepositoryVersionThrows)
		{
			// Set expectations
			EXPECT_CALL(*m_WindowsTpmRepository, GetWindowsTpmVersion())
				.Times(1)
		...
		TEST_F(SecureMnemonicServiceTest, GetTPMStatusAsync_ReturnsTPMVersionUnsupportedIfTpmVersionLessThan2)
		{
			auto tpmVersion = 1;
			// Set expectations
			EXPECT_CALL(*m_WindowsTpmRepository, GetWindowsTpmVersion())
		...
		TEST_F(SecureMnemonicServiceTest, GetBiometryStatusAsync_ReturnsNotSupportedIfWindowsHelloUnsupported) {
			// Set expectations
		...
		TEST_F(SecureMnemonicServiceTest, GetBiometryStatusAsync_ReturnsSupportedIfWindowsHelloSupported) {
			// Set expectations
		...
		TEST_F(SecureMnemonicServiceTest, GenerateKeyAsync_CallsCreateCredentialWithCorrectTag) {
			// Arrange
		...
		TEST_F(SecureMnemonicServiceTest, DeleteKeyAsync_CallsDeleteCredentialWithCorrectTag)
		{
			// Arrange
		...
		TEST_F(SecureMnemonicServiceTest, EncryptAsync_ThrowsIfDataToSignEmpty)
		{
			// Arrange
		...
		TEST_F(SecureMnemonicServiceTest, EncryptAsync_ReturnsEncryptedString)
		{
		...
		TEST_F(SecureMnemonicServiceTest, DecryptAsync_ReturnsDecryptedString)
		{
